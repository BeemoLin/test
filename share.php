...
mysql_select_db($database_connSQL, $connSQL);
$query_RecShare = "SELECT * FROM `share` ORDER BY share_date DESC";
...
if (!empty($_SERVER['QUERY_STRING'])) {
  ...
  foreach ($params as $param) {
    if (stristr($param, "pageNum_RecShare") == false &&
    stristr($param, "totalRows_RecShare") == false) {
...
$queryString_RecShare = sprintf("&totalRows_RecShare=%d%s", $totalRows_RecShare, $queryString_RecShare);
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="59%" align="center" valign="middle">標題</td>
                                          <td width="13%" align="right" valign="middle">人氣</td>
                                          <td width="28%" align="center" valign="middle">日期</td>
                                        </tr>
                                        <tr>
                                          <td colspan="3" align="center" valign="middle" style="border: 0px solid white; border-top-width: 2px; border-bottom-width: 2px;"></td>
                                        </tr>
                                      </table>
                                    </td>
                                  </tr>
                                    ...
                                    <td>
                                      ...
                                      <?php do { ?>
                                        <tr onMouseOver="mark(this,'#000000','#FFFFFF')" onMouseOut="mark(this,'','#FFFFFF')">
                                          ...
                                          <td width="467"><a href="share_show_word.php?share_id=<?php echo $row_RecShare['share_id']; ?>"> <?php echo $row_RecShare['share_picture']; ?> </a> <a href="share_show_movie.php?share_id=<?php echo $row_RecShare['share_id']; ?>"> <?php echo $row_RecShare['share_movie']; ?> </a> <a href="share_show_movie.php?share_id=<?php echo $row_RecShare['share_id']; ?>"> <?php echo $row_RecShare['share_name']; ?> </a> <a
                                            href="share_show_word.php?share_id=<?php echo $row_RecShare['share_id']; ?>"> <?php echo $row_RecShare['share_title']; ?> </a>
                                          </td>
                                          <td width="49" align="right"><?php echo $row_RecShare['share_hits']; ?>
                                          </td>
                                          <td width="210" align="center"><?php echo $row_RecShare['share_date']; ?>
                                          </td>
                                        </tr>
...
$separator = " ";
$max_links = 10;
$pages_navigation_RecShare = buildNavigation($pageNum_RecShare,$totalPages_RecShare,$prev_RecShare,$next_RecShare,$separator,$max_links,true); 

print $pages_navigation_RecShare[0]; 
?> <?php print $pages_navigation_RecShare[1]; ?> <?php print $pages_navigation_RecShare[2]; ?>
                        </td>
                      </tr>
                    </table>
                  </td>
