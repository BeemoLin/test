...
if (!defined('ROOT_PATH')) {
  ...
  define('CONSTRUCTION_CASE','cctest');                                //驗証名稱   (如有新建案 請改此處)
  define('PATH', ROOT_PATH.'/cctest');                                 //目前目錄   (如有新建案 請改此處)
  ...
  define('C_SUBJECT', '親家新觀');                                   //中文名稱   (如有新建案 請改此處)
  define('E_SUBJECT', 'cctest');                                       //英文名稱   (如有新建案 請改此處)
  ...
  $database_connSQL = "cctest";                                       //資料庫名稱     (如有新建案 請改此處)
  $username_connSQL = "root";                                       //資料庫帳號名稱 (如有新建案 請改此處)
  $password_connSQL = "Tcwa0428742715";                                       //資料庫帳號密碼 (如有新建案 請改此處)
