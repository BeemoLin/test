...
$pages->setDb('mail_management'," AND `m_username`= '".$username."' AND `show`='1'   ORDER BY `mail_management`.`disable` ASC, `mail_management`.`receives_time` DESC ",'*');
//die($pages->sql);
$pages->setPerpage(6,$page);
$pages->set_base_page('mail.php');//announcement.php
