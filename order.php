...
mysql_select_db($database_connSQL, $connSQL);
$query_Recordset1 = "SELECT * FROM `order_rulepic` ORDER BY `order_rulepic`.`rulepic_id` ASC";
...
mysql_select_db($database_connSQL, $connSQL);
$query_Recordset2 = "SELECT * FROM order_all_pic ORDER BY oa_id ASC";
$query_limit_Recordset2 = sprintf("%s LIMIT %d, %d", $query_Recordset2, $startRow_Recordset2, $maxRows_Recordset2);
$Recordset2 = mysql_query($query_limit_Recordset2, $connSQL) or die(mysql_error());
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="40">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="45%"><img src="img/img/q_BTN.png" align="absmiddle" /> <span class="org">開放設備清單</span>
                                    </td>
                                    <td width="55%">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center"><img src="img/BTN/OPEN_dn.png"  width="130" height="30" border="0" />
                                          </td>
                                          <td align="center"><a href="test_orderready.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image28','','img/BTN/already_dn.png',1)"> <img src="img/BTN/already_up.png"  name="Image28" width="130" height="30" border="0" id="Image28" /> </a>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
                          ...
                          <table width="750" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="229" height="330" align="left" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="300" align="left" valign="top"><?php 
                                    if(isset($Recordset1)){
                                      while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)) {
                                        ?>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr onmouseover="mark(this,'#000000','#FFFFFF')" onmouseout="mark(this,'','#FFFFFF')">
                                          <td align="center" height="30"><span class="white"> <a href="test_orderrule.php?rulepic_id=<?php echo $row_Recordset1['rulepic_id']; ?>&amp;name=<?php echo $row_Recordset1['name']; ?>"> <?php echo $row_Recordset1['name']; ?> </a> </span>
                                          </td>
                                        </tr>
                                        <tr>
                              ...
                              <td width="521" align="center" valign="top">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td height="281" align="left" valign="top"><br /> 
																		<?php 
																		 while ($row_Recordset2 = mysql_fetch_assoc($Recordset2)){
																		?>
                                      <table width="100" border="0" cellpadding="0" cellspacing="0" class="w">
                                        <tr>
                                          <td align="center" valign="middle">
																						<a href="ordersshowlage.php?oa_id=<?php echo $row_Recordset2['oa_id']; ?>">
																							<img src="backstage/newpic/<?php echo $row_Recordset2['oa_pic']; ?>"  width="80" height="80" border="0" />
																						</a>
																						<br />
																						<?php echo $row_Recordset2['oa_name']; ?>
                                          </td>
                                        </tr>
                                      </table>
																		<?php
                                  ...
                                  <tr>
                                    <td height="50" align="center" valign="middle">
                                      <table border="0">
                                        <tr>
                                          <td><?php if ($pageNum_Recordset2 > 0) { // Show if not first page ?> <a href="<?php printf("%s?pageNum_Recordset2=%d%s", $currentPage, 0, $queryString_Recordset2); ?>">第一頁</a> <?php } // Show if not first page ?>
                                          </td>
                                          <td><?php if ($pageNum_Recordset2 > 0) { // Show if not first page ?> <a href="<?php printf("%s?pageNum_Recordset2=%d%s", $currentPage, max(0, $pageNum_Recordset2 - 1), $queryString_Recordset2); ?>">上一頁</a> <?php } // Show if not first page ?>
                                          </td>
                                          <td><?php if ($pageNum_Recordset2 < $totalPages_Recordset2) { // Show if not last page ?> <a href="<?php printf("%s?pageNum_Recordset2=%d%s", $currentPage, min($totalPages_Recordset2, $pageNum_Recordset2 + 1), $queryString_Recordset2); ?>">下一頁</a> <?php } // Show if not last page ?>
                                          </td>
                                          <td><?php if ($pageNum_Recordset2 < $totalPages_Recordset2) { // Show if not last page ?> <a href="<?php printf("%s?pageNum_Recordset2=%d%s", $currentPage, $totalPages_Recordset2, $queryString_Recordset2); ?>">最後一頁</a> <?php } // Show if not last page ?>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
