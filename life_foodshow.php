...
$query_Update = "UPDATE food SET food_hits=food_hits+1 WHERE food_id = ".$_GET["food_id"];
...
if (isset($_GET['food_id'])) {
  $colname_RecFood = $_GET['food_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecFood = sprintf("SELECT * FROM food WHERE food_id = %s", GetSQLValueString($colname_RecFood, "int"));
...
$colname_RecPhoto2 = "-1";
if (isset($_GET['food_id'])) {
  $colname_RecPhoto2 = $_GET['food_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecPhoto2 = sprintf("SELECT * FROM food_photo2 WHERE food_id = %s ORDER BY app_date ASC", GetSQLValueString($colname_RecPhoto2, "int"));
