...
$query_Update = "UPDATE teach SET teach_hits=teach_hits+1 WHERE teach_id = ".$_GET["teach_id"];
...
if (isset($_GET['teach_id'])) {
  $colname_RecTeach = $_GET['teach_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecTeach = sprintf("SELECT * FROM teach WHERE teach_id = %s", GetSQLValueString($colname_RecTeach, "int"));
...
$colname_RecPhoto2 = "-1";
if (isset($_GET['teach_id'])) {
  $colname_RecPhoto2 = $_GET['teach_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecPhoto2 = sprintf("SELECT * FROM teach_photo2 WHERE teach_id = %s ORDER BY app_date ASC", GetSQLValueString($colname_RecPhoto2, "int"));
