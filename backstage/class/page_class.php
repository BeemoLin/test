...
class sam_pages_class{
  ...
  function getFirstpage($page_name = null){                                  //取得第一頁
    ...
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'tblname\':\'news_album\',\'action_mode\':\'view_all_data\',\'page\':\'1\'})">第一頁</a></li>'."&nbsp;" ;
    return $page;
  }
  
  function getEndpage($page_name = null){                                    //取得最終頁
    $page="";
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'tblname\':\'news_album\',\'action_mode\':\'view_all_data\',\'page\':\''.$this->total_pages.'\'})">第終頁</a></li>' ;
    return $page;
  }
  ...
  function getListpage($view_page, $page_name = null){               //取得頁數列表
    ...
    for($i=$this->now_page-$this->view_page;$i<$this->now_page;$i++){
      if($i>0){
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\'view_all_data\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
      }
    }
    $page.='<li class="active"><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\'view_all_data\',\'page\':\''.$this->now_page.'\'})" style="font-weight:bold;color:red;">'.$this->now_page.'</a></li>'."&nbsp;" ;
  ...
  function getFirstpage2($page_name = null){                                  //取得第一頁
    $page="";
    //$page.='<a href="?page=1" >第一頁</a>' ;
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'page\':\'1\'})">第一頁</a></li>'."&nbsp;" ;
    return $page;
  }
  
  function getEndpage2($page_name = null){                                    //取得最終頁
    $page="";
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'page\':\''.$this->total_pages.'\'})">第終頁</a></li>' ;
    return $page;
  }
  ...
  function getListpage2($view_page,$page_name = null){               					//取得頁數列表
    ...
    for($i=$this->now_page-$this->view_page;$i<$this->now_page;$i++){
      if($i>0){
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
      }
    }
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'page\':\''.$this->now_page.'\'})" style="font-weight:bold;color:red;">'.$this->now_page.'</a></li>'."&nbsp;" ;
    for($i=$this->now_page+1;$i<=$this->now_page+$this->view_page;$i++){
      if($i<=$this->total_pages){
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
      }
  ...
  //==================================================================食衣住行的分頁
    ...
    $page="";
    //$page.='<a href="?page=1" >第一頁</a>' ;
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'life_name\':\''.$equipment_id.'\',\'page\':\'1\'})">第一頁</a></li>'."&nbsp;" ;
    //var_dump($page);
    return $page;
  }
  ...
  function getEndpageForBackStage3($equipment_id, $page_name = null){                                    //取得最終頁 (生活資訊特製)
    $page="";
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'life_name\':\''.$equipment_id.'\',\'page\':\''.$this->total_pages.'\'})">第終頁</a></li>' ;
     //var_dump($page);
    return $page;
  }
  //----頁數 呈現的方式修改 要研究看看  一個是現在停留(Prepage)的頁數與要選擇(Nowpage)的頁數切換 比對 要去絕對值 且要記錄
  function getListpageForBackStage3($equipment_id, $view_page,$page_name = null){               					//取得頁數列表 (生活資訊特製)
    $page='';
    ...
    for($i=$this->now_page-$this->view_page;$i<$this->now_page;$i++)
    {
      if($i>0)
      {
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'life_name\':\''.$equipment_id.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
       // echo "2.".$page."頁";
      }
    }
    //echo "2.".$page."頁";
    //3.頁上上呈現現在被點的頁數為紅色;目前的頁數;如點3 只跑3
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'life_name\':\''.$equipment_id.'\',\'page\':\''.$this->now_page.'\'})" style="font-weight:bold;color:red;">'.$this->now_page.'</a></li>'."&nbsp;" ;
  ...
  function getFirstpage3($equipment_id, $page_name = null){                                  //取得第一頁 (生活資訊特製)
    $page="";
    //$page.='<a href="?page=1" >第一頁</a>' ;
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'equipment_id\':\''.$equipment_id.'\',\'page\':\'1\'})">第一頁</a></li>'."&nbsp;" ;
    return $page;
  }
  
  function getEndpage3($equipment_id, $page_name = null){                                    //取得最終頁 (生活資訊特製)
    $page="";
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'equipment_id\':\''.$equipment_id.'\',\'page\':\''.$this->total_pages.'\'})">第終頁</a></li>' ;
    return $page;
  }
  //----頁數 呈現的方式修改 要研究看看  一個是現在停留(Prepage)的頁數與要選擇(Nowpage)的頁數切換 比對 要去絕對值 且要記錄
  ...
  {               					//取得頁數列表 (生活資訊特製)
    ...
    for($i=$this->now_page-$this->view_page;$i<$this->now_page;$i++)
    {
      if($i>0)
      {
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'equipment_id\':\''.$equipment_id.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
       // echo "2.".$page."頁";
      }
    }
    //echo "2.".$page."頁";
    //3.頁上上呈現現在被點的頁數為紅色;目前的頁數;如點3 只跑3
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'equipment_id\':\''.$equipment_id.'\',\'page\':\''.$this->now_page.'\'})" style="font-weight:bold;color:red;">'.$this->now_page.'</a></li>'."&nbsp;" ;
  ...
  function getFirstpage4($keyword, $page_name = null){                                  //取得第一頁 (查詢發放特製)
    $page="";
    //$page.='<a href="?page=1" >第一頁</a>' ;
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'keyword\':\''.$keyword.'\',\'page\':\'1\'})">第一頁</a></li>'."&nbsp;" ;
    return $page;
  }
  
  function getEndpage4($keyword, $page_name = null){                                    //取得最終頁 (查詢發放特製)
    $page="";
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'keyword\':\''.$keyword.'\',\'page\':\''.$this->total_pages.'\'})">第終頁</a></li>' ;
    return $page;
  }
  ...
  function getListpage4($keyword, $view_page,$page_name = null){               					//取得頁數列表 (查詢發放特製)
    ...
    for($i=$this->now_page-$this->view_page;$i<$this->now_page;$i++){
      if($i>0){
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'keyword\':\''.$keyword.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
      }
    }
    $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'keyword\':\''.$keyword.'\',\'page\':\''.$this->now_page.'\'})" style="font-weight:bold;color:red;">'.$this->now_page.'</a></li>'."&nbsp;" ;
    for($i=$this->now_page+1;$i<=$this->now_page+$this->view_page;$i++){
      if($i<=$this->total_pages){
        $page.='<li><a href="#" onclick="post_to_url(\''.$this->page_name.'\', {\'action_mode\':\''.$this->action_mode.'\',\'keyword\':\''.$keyword.'\',\'page\':\''.$i.'\'})">'.$i.'</a></li>'."&nbsp;" ;
      }
