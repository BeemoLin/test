...
<div id="pic3">
    ...
    <a href="#" onclick="post_to_url('backindex_equipment.php', {'action_mode':'view_reservation_data'})" >綜合預約列表</a><br /> -->
		<a href="#" class="btn btn-success" onclick="post_to_url('backindex_equipment.php', {'action_mode':'add_equipment'})" >新增設備</a><br />
      ...
      ?>
				<tr height="40">
					...
					<td style="text-align: center;"><a href="#" class="btn btn-warning btn-sm" onclick="post_to_url('backindex_equipment.php', {'action_mode':'set_equipment','equipment_id':'<?php echo $value['equipment_id'];?>'})" >設定</a></td>
					...
					if($value['equipment_advance']=='0'){
						...
						echo '<td style="text-align: center;"><a href="#" class="btn btn-info btn-sm" onclick="'."post_to_url('backindex_equipment.php', {'action_mode':'view_reservation_data','equipment_id':'".$value['equipment_id']."'})".'" >查看</a></td>'."\n";
					}
					?>
					<?php if($_SESSION['MM_UserGroup']=='權限管理者'){?><td style="text-align: center;"><a href="#" class="btn btn-danger btn-sm" onclick="tfm_confirmLink('你確定要刪除???','backindex_equipment.php', {'action_mode':'del_equipment','equipment_id':'<?php echo $value['equipment_id'];?>'})" >刪除</a></td><?php }?>
				</tr>
      <?php
        }
			}
