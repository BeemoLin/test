		...
		<div>
            ...
            <?php 
              if(isset($value['equipment_picture'])){
								echo '<input type="button" value="刪除" onclick="tfm_confirmLink'."('你確定要刪除???','backindex_equipment.php',{'action_mode':'delete_pic','equipment_id':'".$value['equipment_id']."','equipment_picture':'".$value['equipment_picture']."'});".'" />'."\n";
              }
            ?>
									</div>
									<div style="float:left">
										<input name="new_equipment_picture" id="new_equipment_picture" type="file" style="display:none"/>
										<input type="button" value="更新" style="" onclick="chang_equipment_picture123()" style="bottom:2px" />
									</div>
								</div>
							</div>
            </td>
              ...
              <input name="equipment_advance" value="1" type="radio" <?php echo $value['equipment_advance']=='1'? 'checked="checked"':''; ?> />是
						...
						<td>
              <input name="equipment_exclusive" value="0" type="radio" <?php echo $value['equipment_exclusive']=='0'? 'checked="checked"':''; ?> />否 　　　
              <input name="equipment_exclusive" value="1" type="radio" <?php echo $value['equipment_exclusive']=='1'? 'checked="checked"':''; ?> />是
            </td>
					</tr>
					<tr>
              ...
              <input name="equipment_hidden" type="radio" value="1" <?php echo $value['equipment_hidden']=='1'? 'checked="checked"':''; ?> />是
					...
					<tr>
						<th align="right" colspan="2" scope="row">
							...
							<input type="button" value="回設備列表" onclick="location.href='backindex_equipment.php';" />
						</th>
					</tr>
				</tbody>
			</table>
