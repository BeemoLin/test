...
<div id="main">
  <div id="main_fix_table">
    <form name="form" id="form" method="post" action="backindex_mail.php">
      ...
      <input type="hidden" name="action_mode" value="fix"><!--control:fix-->
...
<!--貨運公司 ：<select name="arr[<?php echo $no; ?>][letter_alt]" id="arr[<?php echo $no; ?>][letter_alt]">-->
      ...
      ?>
        ...
        <div style="float: left">
          ...
          <input type="hidden" name='space1_code' id="space1_code" />存圖檔的編碼用
          <input type="hidden" name='space2_code' id="space2_code" />-->
          <input type="button" class="btn btn-success" id="bGenImage" value="確定發件"><!--檢查winform送入後端的攔位內容條件-->
          <!--<input type="reset" value="清除重填">-->
          <?php if($no<2){?>
          <input type="button" class="btn btn-warning" id="bUpdateDB" value="資料修正">
          <?php }?>
          <input type="button" class="btn btn-danger" id="back" value="回上一頁" onClick="post_to_url('backindex_mail.php', {'action_mode':'give_list'})" />
