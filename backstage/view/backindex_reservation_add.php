<?php
/*20121117
增加input type=hidden 攔位,紀錄預約結束時間
*/
?>
...
var end_hour;// 20121117增加設備的結束時間\
...
//		alert(v4);
    ...
    else
    {
        ...
        var equipmentid= document.getElementById("set_equipment_id").value;
        var listtime= v4;
        ...
        //alert(document.getElementById("list_endtime").value);
        //return;
       // return;
       // document.getElementById("list_time_format").value=listtime+"~"+hour+":"+min+":"+sec; 寄信用
...
<div>
    ...
    <input type="hidden" name="list_endtime" id="list_endtime" value="" >
