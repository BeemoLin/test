...
<div style="width: 844px;">
  ...
  <p>
    <a href="#" onclick="post_to_url('backindex_rules.php', {'action_mode':'add_rules_view'})">新增規約辦法</a> 　　
  ...
  <table width="844" border="0" align="left" cellpadding="0" cellspacing="0">
	...
	if(isset($data)){
		...
		<tr style="text-align: left">
		  ...
		  <th width="45" align="left"><a href="#" onclick="tfm_confirmLink('你確定要刪除???','backindex_rules.php',{'action_mode':'delete','rules_id':'<?php echo $v1['rules_id']; ?>'});">刪除</a></th>
		</tr>
		<?php 
		} 
	}
