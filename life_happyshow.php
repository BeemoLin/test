...
$query_Update = "UPDATE happy SET happy_hits=happy_hits+1 WHERE happy_id = ".$_GET["happy_id"];
...
$colname_RecHappy = "-1";
if (isset($_GET['happy_id'])) {
  $colname_RecHappy = $_GET['happy_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecHappy = sprintf("SELECT * FROM happy WHERE happy_id = %s", GetSQLValueString($colname_RecHappy, "int"));
...
$colname_RecPhoto2 = "-1";
if (isset($_GET['happy_id'])) {
  $colname_RecPhoto2 = $_GET['happy_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecPhoto2 = sprintf("SELECT * FROM happy_photo2 WHERE happy_id = %s ORDER BY app_date ASC", GetSQLValueString($colname_RecPhoto2, "int"));
