...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="all" style="width:1024px;border:0px;padding:0px;border-spacing:0px">
			<div id="allleft" >
				<div id="allleft_top" >
				</div>
		  <div id="allleft_botton">
					...
					<div class="left_botton"><img name="opinion" id="opinion" alt="意見反應" src="./images/back_btn/opinion_out.gif" onmouseover="onMouseOverImage('opinion')" onmouseout="onMouseOutImage('opinion')" onclick="post_to_url('backindexopinion.php', {'action_mode':'view_all_data'})" /></div>
					<div class="left_botton"><img name="" id="equipment" alt="公設預約" src="./images/back_btn/equipment_out.gif" onmouseover="onMouseOverImage('equipment')" onmouseout="onMouseOutImage('equipment')" onclick="post_to_url('backindex_appointment.php', {'action_mode':'view_all_data'})" /></div>
