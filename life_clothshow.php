...
$query_Update = "UPDATE cloth SET cloth_hits=cloth_hits+1 WHERE cloth_id = ".$_GET["cloth_id"];
...
if (isset($_GET['cloth_id'])) {
  $colname_RecCloth = $_GET['cloth_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecCloth = sprintf("SELECT * FROM cloth WHERE cloth_id = %s", GetSQLValueString($colname_RecCloth, "int"));
$RecCloth = mysql_query($query_RecCloth, $connSQL) or die(mysql_error());
$row_RecCloth = mysql_fetch_assoc($RecCloth);
$totalRows_RecCloth = mysql_num_rows($RecCloth);

$colname_RecPhoto2 = "-1";
if (isset($_GET['cloth_id'])) {
  $colname_RecPhoto2 = $_GET['cloth_id'];
}
mysql_select_db($database_connSQL, $connSQL);
$query_RecPhoto2 = sprintf("SELECT * FROM cloth_photo2 WHERE cloth_id = %s ORDER BY app_id ASC", GetSQLValueString($colname_RecPhoto2, "int"));
