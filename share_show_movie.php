                ...
                <tr>
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="40"><img src="img/img/q_BTN.png"  align="absmiddle" /> <span class="org"> <?php echo $row_RecShare['share_name']; ?> </span>
                        </td>
                      </tr>
                      <tr>
                        <td height="30">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="55%" height="30" align="left">發表者：<?php echo $row_RecShare['share_sharename']; ?>
                              </td>
                              <td width="45%">發布時間：<?php echo $row_RecShare['share_date']; ?>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td height="270">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="13%" height="270">&nbsp;</td>
                              <td width="79%" align="center" valign="middle"><?php 
			if ($row_RecShare['share_url'] == NULL){}
			else{ ?> <a href="<?php echo $row_RecShare['share_url']; ?>" class="p"> <img src="img/img/go.png" width="150" height="30" border="0" /> </a> <?php } ?>
                              </td>
                              <td width="8%">&nbsp;</td>
                            </tr>
                          </table>
                        ...
                        <td height="30">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="19%" align="right"><a href="share.php"> <img src="img/BTN/back.png"  width="110" height="30" border="0" /> </a> <a href="announcement.php"> </a>
                              </td>
                            </tr>
                          </table>
                        </td>
